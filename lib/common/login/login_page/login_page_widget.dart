...
class LoginPageWidget extends StatefulWidget {
  const LoginPageWidget({
    super.key,
    bool? showAnonLogin,
  }) : this.showAnonLogin = showAnonLogin ?? false;

  final bool showAnonLogin;
                    ...
                    children: [
                      Flexible(
                        child: Container(
                          ...
                          child: Visibility(
                            visible:
                                isWeb ? FFAppState().debugWebToMobile : true,
                            child: Image.asset(
                              'assets/images/8cfe44de2feeb09753fd22ae6e2dd050.png',
                              width: double.infinity,
                              fit: BoxFit.fitWidth,
                              ...
                              if (isWeb
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    _model.subscriptionEndTime = await actions
