...
Future<List<CategoriesRecord>> meditationsGetCategories(
    MeditationsRecord meditationDoc) async {
  List<Future<DocumentSnapshot>> addFutures = [];

  meditationDoc.categories.forEach((element) => addFutures.add(element.get()));
