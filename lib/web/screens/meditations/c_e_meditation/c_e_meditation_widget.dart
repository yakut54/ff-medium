...
import 'c_e_meditation_model.dart';
export 'c_e_meditation_model.dart';

class CEMeditationWidget extends StatefulWidget {
  const CEMeditationWidget({
    super.key,
    this.meditationDoc,
  ...
  @override
  State<CEMeditationWidget> createState() => _CEMeditationWidgetState();
}

class _CEMeditationWidgetState extends State<CEMeditationWidget> {
  late CEMeditationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEMeditationModel());
