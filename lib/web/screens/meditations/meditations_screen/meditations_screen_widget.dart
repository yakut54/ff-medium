...
import 'meditations_screen_model.dart';
export 'meditations_screen_model.dart';

class MeditationsScreenWidget extends StatefulWidget {
  const MeditationsScreenWidget({super.key});

  @override
  State<MeditationsScreenWidget> createState() =>
      _MeditationsScreenWidgetState();
}

class _MeditationsScreenWidgetState extends State<MeditationsScreenWidget> {
  late MeditationsScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditationsScreenModel());
                                      ...
                                      return Wrap(
                                        ...
                                        children:
                                          ...
                                          return MeditationCardWidget(
                                            key: Key(
                                                'Keyhec_${meditationsIndex}_of_${meditations.length}'),
